...
// The current working directory should be project root of the app that is linking
...
if (config.ios) {
    ...
    ['CoreText.framework', 'QuartzCode.framework', 'CoreGraphics.framework', 'UIKit.framework', 'CoreImage.framework'].forEach(function(name) {
